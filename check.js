...
async function runOcrForAllImages() {
  ...
  try {
    setProgress('Leyendo capturas con OCR...', 5);
    ...
    for (let i = 0; i < state.images.length; i += 1) {
      ...
      setProgress('Leyendo capturas con OCR...', Math.round(((i + 1) / state.images.length) * 100));
    }
